...
export const ViewMarkedSurfers = styled.View`
  width: ${width}px;
  flex-direction: row;
  align-items: center;
...
export const MarkedSurfersButton = styled.TouchableOpacity`
  flex: 0.4;
  flex-direction: row;
  align-items: center;
  padding: 5px 10px;
...
export const MarkedSurferName = styled.Text.attrs({
  ellipsizeMode: 'tail',
  numberOfLines: 1,
})`
  font-size: 12px;
...
export const TagSurferButton = styled.TouchableOpacity`
  position: absolute;
  right: 16px;
  bottom: 16px;
  flex-direction: row;
